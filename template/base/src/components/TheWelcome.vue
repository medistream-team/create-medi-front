...
<template>
  <WelcomeItem>
    <template #icon>
      <i class="ii-2x ii-document-with-lines-outline"></i>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <i class="ii-2x ii-settings-outline"></i>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <i class="ii-2x ii-gift-outline"></i>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <i class="ii-2x ii-message-dots-outline"></i>
    </template>
